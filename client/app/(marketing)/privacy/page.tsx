      ...
      <div className="flex flex-col gap-10 text-sm leading-relaxed text-text-muted">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 flex flex-col gap-1.5">
              ...
              <li>
                <strong className="text-white">Sentry</strong> — used for error monitoring.
          ...
          <section>
            ...
            <ul className="list-disc pl-5 flex flex-col gap-1.5 mt-2">
              ...
              <li>
                <code className="text-xs bg-white/[0.04] px-1.5 py-0.5 rounded">user</code> — your user profile
                (name, email), used to personalize the interface without an extra API call.
              </li>
            </ul>
            <p className="mt-2">
              Both cookies are set with <code className="text-xs bg-white/[0.04] px-1.5 py-0.5 rounded">SameSite=Lax</code> and
          ...
          <section>
            ...
            <p>
              ...
              at{" "}
              <a href="mailto:privacy@gocast.fm" className="text-violet-fullno-underline hover:underline">
                privacy@gocast.fm
              </a>.
            </p>
          </section>
